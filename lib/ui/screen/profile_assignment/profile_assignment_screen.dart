...
class _ProfileAssignmentScreenWidgetState
    extends State<_ProfileAssignmentScreenWidget> {
          ...
          children: <Widget>[
            Padding(
                ...
                child: SizedBox(
                    width: 100,
                    height: 100,
                    child: SvgPicture.asset("assets/icons/monitor.svg",
                        color: HexColor.fromHex("#DDDFE3")))),
            Text(
              localizations.getLocalization("assignment_content"),
              textScaleFactor: 1.0,
              style:
                  TextStyle(color: HexColor.fromHex('#2A3045'), fontSize: 20.0),
