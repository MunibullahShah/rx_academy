...
import 'package:rx_academy/ui/bloc/assignment/assignment_event.dart';
...
class AssignmentDraftWidget extends StatefulWidget {
  ...
  const AssignmentDraftWidget(Key key, this._bloc, this.assignmentResponse,
      this.courseId, this.assignmentId, this.userAssignmentId)
      : super(key: key);
...
class AssignmentDraftWidgetState extends State<AssignmentDraftWidget> {
                          ...
                          Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: widget
                                      .assignmentResponse.translations.title,
                          ...
                          Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: widget
                                      .assignmentResponse.translations.content,
                                  alignLabelWithHint: true,
                                  filled: true,
                                  fillColor: HexColor.fromHex("#F6F6F6"),
                                ),
                                          ...
                                          child: SizedBox(
                                              ...
                                              child: SvgPicture.asset(
                                                  ...
                                                  color: HexColor.fromHex(
                                                      "#FFFFFF")))),
                                      Text(
                                        widget.assignmentResponse.translations
                                            .files,
                                        textScaleFactor: 1.0,
                                        style: TextStyle(
                                            color: Colors.white,
  ...
  void addAssignment(bool add) {
    ...
    widget._bloc.add(AddAssignmentEvent(widget.courseId, widget.assignmentId,
        widget.userAssignmentId, content, files));
  }
}
