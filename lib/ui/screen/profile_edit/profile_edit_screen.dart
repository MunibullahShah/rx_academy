...
import 'package:rx_academy/ui/bloc/profile/profile_bloc.dart';
import 'package:rx_academy/ui/bloc/profile/profile_event.dart';
...
class _ProfileEditWidgetState extends State<_ProfileEditWidget> {
  ...
  _saveForm() async {
    if (_formKey.currentState.validate()) {
      ...
      provide.Provider.of<LanguageBloc>(context, listen: false).language =
          language;
      localizations.isArabic = !(language == "English");
      _bloc.add(SaveEvent(
        ...
        children: <Widget>[
          ...
          language == null
              ...
              : Padding(
                  ...
                  child: Text(localizations.getLocalization("language"))),
          language == null
              ? Container()
              : Padding(
                  padding:
