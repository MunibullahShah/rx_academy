...
import 'package:rx_academy/ui/bloc/course/course_bloc.dart';
...
class UserCourseLockedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final UserCourseLockedScreenArgs args =
        ModalRoute.of(context).settings.arguments;
    return BlocProvider(
        create: (context) => _bloc,
        child: UserCourseLockedWidget(args.courseId));
  }
}
  ...
  Widget build(BuildContext context) {
    return BlocListener(
      listener: (context, state) {
        if (state.courseDetailResponse.has_access) Navigator.of(context).pop();
      },
            ...
            children: <Widget>[
              ...
              Container(
                decoration: BoxDecoration(
                    color: HexColor.fromHex("#2A3045").withOpacity(0.7)),
              ),
              Container(
                height: MediaQuery.of(context).size.height / 3.3,
                child: Padding(
                        ...
                        children: <Widget>[
                                ...
                                GestureDetector(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    (state is LoadedCourseState)
                                        ? state.courseDetailResponse.author
                                            .avatar_url
                                        : "",
                                  )),
                                )
                          ...
                          Padding(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text(
                                localizations
                                    .getLocalization("continue_button"),
                                textScaleFactor: 1.0,
                              ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                localizations
                    .getLocalization("trial_version_is_over_description"),
                textScaleFactor: 1.0,
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontSize: 15.0, color: HexColor.fromHex("#AAAAAA")),
              ),
            )
          ],
        ));
