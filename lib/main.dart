...
import 'package:rx_academy/data/repository/localization_repository.dart';
import 'package:rx_academy/theme/theme.dart';
import 'package:rx_academy/ui/bloc/assignment/assignment_bloc.dart';
import 'package:rx_academy/ui/bloc/category_detail/bloc.dart';
import 'package:rx_academy/ui/bloc/course/bloc.dart';
import 'package:rx_academy/ui/bloc/courses/bloc.dart';
import 'package:rx_academy/ui/bloc/detail_profile/bloc.dart';
import 'package:rx_academy/ui/bloc/edit_profile_bloc/bloc.dart';
import 'package:rx_academy/ui/bloc/favorites/bloc.dart';
import 'package:rx_academy/ui/bloc/final/bloc.dart';
import 'package:rx_academy/ui/bloc/home/bloc.dart';
import 'package:rx_academy/ui/bloc/home_simple/bloc.dart';
import 'package:rx_academy/ui/bloc/language_bloc.dart';
import 'package:rx_academy/ui/bloc/lesson_stream/bloc.dart';
import 'package:rx_academy/ui/bloc/lesson_video/bloc.dart';
import 'package:rx_academy/ui/bloc/orders/orders_bloc.dart';
import 'package:rx_academy/ui/bloc/plans/plans_bloc.dart';
import 'package:rx_academy/ui/bloc/profile/bloc.dart';
import 'package:rx_academy/ui/bloc/profile_assignment/profile_assignment_bloc.dart';
import 'package:rx_academy/ui/bloc/question_ask/bloc.dart';
import 'package:rx_academy/ui/bloc/question_details/bloc.dart';
import 'package:rx_academy/ui/bloc/questions/bloc.dart';
import 'package:rx_academy/ui/bloc/quiz_lesson/quiz_lesson_bloc.dart';
import 'package:rx_academy/ui/bloc/quiz_screen/quiz_screen_bloc.dart';
import 'package:rx_academy/ui/bloc/restore_password/restore_password_bloc.dart';
import 'package:rx_academy/ui/bloc/review_write/bloc.dart';
import 'package:rx_academy/ui/bloc/search/bloc.dart';
import 'package:rx_academy/ui/bloc/search_detail/bloc.dart';
import 'package:rx_academy/ui/bloc/text_lesson/bloc.dart';
import 'package:rx_academy/ui/bloc/user_course/bloc.dart';
import 'package:rx_academy/ui/bloc/user_course_locked/bloc.dart';
import 'package:rx_academy/ui/bloc/video/bloc.dart';
import 'package:rx_academy/ui/screen/assignment/assignment_screen.dart';
import 'package:rx_academy/ui/screen/auth/auth_screen.dart';
import 'package:rx_academy/ui/screen/category_detail/category_detail_screen.dart';
import 'package:rx_academy/ui/screen/course/course_screen.dart';
import 'package:rx_academy/ui/screen/detail_profile/detail_profile_screen.dart';
import 'package:rx_academy/ui/screen/final/final_screen.dart';
import 'package:rx_academy/ui/screen/lesson_stream/lesson_stream_screen.dart';
import 'package:rx_academy/ui/screen/lesson_video/lesson_video_screen.dart';
import 'package:rx_academy/ui/screen/main/main_screen.dart';
import 'package:rx_academy/ui/screen/plans/plans_screen.dart';
import 'package:rx_academy/ui/screen/profile_assignment/profile_assignment_screen.dart';
import 'package:rx_academy/ui/screen/profile_edit/profile_edit_screen.dart';
import 'package:rx_academy/ui/screen/question_ask/question_ask_screen.dart';
import 'package:rx_academy/ui/screen/question_details/question_details_screen.dart';
import 'package:rx_academy/ui/screen/questions/questions_screen.dart';
import 'package:rx_academy/ui/screen/quiz_lesson/quiz_lesson_screen.dart';
import 'package:rx_academy/ui/screen/quiz_screen/quiz_screen.dart';
import 'package:rx_academy/ui/screen/restore_password/restore_password_screen.dart';
import 'package:rx_academy/ui/screen/review_write/review_write_screen.dart';
import 'package:rx_academy/ui/screen/search_detail/search_detail_screen.dart';
import 'package:rx_academy/ui/screen/splash/splash_screen.dart';
import 'package:rx_academy/ui/screen/text_lesson/text_lesson_screen.dart';
import 'package:rx_academy/ui/screen/user_course/user_course.dart';
import 'package:rx_academy/ui/screen/user_course_locked/user_course_locked_screen.dart';
import 'package:rx_academy/ui/screen/video_screen/video_screen.dart';
import 'package:rx_academy/ui/screen/web_checkout/web_checkout_screen.dart';
import 'package:rx_academy/ui/widgets/message_notification.dart';
import 'package:overlay_support/overlay_support.dart';
import 'package:page_transition/page_transition.dart';
import 'package:path_provider/path_provider.dart';
import 'package:provider/provider.dart' as myprovide;
...
Future<String> getArabicLocalization() async {
  String data =
      await rootBundle.loadString('assets/localization/custom_locale.json');
  return data;
}
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) {
        return widget.profileBloc();
      },
      child: myprovide.ChangeNotifierProvider(
        create: (_) => LanguageBloc(language),
        child: OverlaySupport(child: MainApp(widget)),
      ),
    );
  }
}
...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String language = myprovide.Provider.of<LanguageBloc>(context).language;
    ...
    return MaterialApp(
      ...
      locale: language == 'عربى' ? Locale('ar') : null,
      supportedLocales: [
        Locale("ar", 'AE'),
      ...
      onGenerateRoute: (routeSettings) {
        switch (routeSettings.name) {
          ...
          case AssignmentScreen.routeName:
            return MaterialPageRoute(
                builder: (context) => AssignmentScreen(widget.assignmentBloc()),
                settings: routeSettings);
          ...
          case QuizLessonScreen.routeName:
            return MaterialPageRoute(
                builder: (context) => QuizLessonScreen(widget.quizLessonBloc()),
                settings: routeSettings);
          case QuestionsScreen.routeName:
            return MaterialPageRoute(
                builder: (context) => QuestionsScreen(widget.questionsBloc()),
                settings: routeSettings);
