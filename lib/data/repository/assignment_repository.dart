...
abstract class AssignmentRepository {
  ...
  Future<AssignmentResponse> addAssignment(
      int course_id, int user_assignment_id, String content);
  Future<String> uploadAssignmentFile(
      int course_id, int user_assignment_id, File file);
}
...
class AssignmentRepositoryImpl extends AssignmentRepository {
  ...
  Future<String> uploadAssignmentFile(
      int course_id, int user_assignment_id, File file) {
    return apiProvider.uploadAssignmentFile(
        course_id, user_assignment_id, file);
  }
}
